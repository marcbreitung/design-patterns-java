...
import DesignPatterns.Creational.AbstractFactory.CeltsBakery;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.assertEquals;

public class CeltsBakeryTest {

    private Bakery bakery;

    @BeforeEach
    public void setUp() {
        bakery = new CeltsBakery();
    }
    ...
    public void bakeBreadsWithIntAndSufficientFlourReturnsNumberOfBakedBreads() {
        bakery.setFlourStock(6);
        assertEquals(2, bakery.bakeBreads(2));
        assertEquals(0, bakery.getFlourStock());
    }
